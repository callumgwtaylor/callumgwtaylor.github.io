---
title: The State of Cholera in Yemen in December
author: ~
date: '2017-12-16'
slug: yemen-cholera-update-december
categories: []
tags: []
Categories:
  - R
...
yemen_map <- sf::st_read("./Admin-1/admin1.shp") %>%
  st_as_sf() %>%
...
gganimate(yemen_cases_gif, "../../static/post/2017-12-16_yemen-cholera-update_files/figure-html/yemen_cases_gif.gif", ani.width=1000, ani.height=500)
```

![](/post/2017-12-16_yemen-cholera-update_files/figure-html/yemen_cases_gif.gif)

```{r cases_line, echo=FALSE, fig.height=6, fig.width=8, message=FALSE, warning=FALSE}
cases_graph <- ggplot(joined_data) +
  geom_line(aes(x = date, y = cases, colour = cases)) +
  scale_colour_gradientn(colours = pal) +
  facet_wrap(~admin1Name) +
  theme_minimal() +
  theme(axis.text.x = element_text(angle=45, hjust = 1, vjust = 1),
        legend.text = element_text(angle=45, vjust = 1),
...
gganimate(yemen_deaths_gif, "../../static/post/2017-12-16_yemen-cholera-update_files/figure-html/yemen_deaths_gif.gif", ani.width=1000, ani.height=500)
```

![](/post/2017-12-16_yemen-cholera-update_files/figure-html/yemen_deaths_gif.gif)
...
death_graph <- ggplot(joined_data) +
  geom_line(aes(x = date, y = deaths, colour = deaths)) +
  scale_colour_gradientn(colours = pal) +
  facet_wrap(~admin1Name) +
  theme_minimal() + 
  theme(axis.text.x = element_text(angle=45, hjust = 1, vjust = 1),
