...
This information has been collated by the Humanitarian Data Exchange (HDX), and put [online](https://data.humdata.org/dataset/yemen-cholera-outbreak-daily-epidemiology-update). I made a new function for [hdxr](callumgwtaylor.github.io/hdxr) the other day to make it easier to use maps from HDX, and wanted to learn more about what's happening in Yemen.
