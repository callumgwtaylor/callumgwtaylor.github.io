...
I've been trying to make it easier to extract data from HDX in R, using tidyverse and ropensci packages. I've started compiling a mini-package called [hdxr](https://github.com/callumgwtaylor/hdxr) that wraps these pipelines up neatly. 
...
![](/post/2017_06_11_pipelines/example_output.png)
...
![](/post/2017_06_11_pipelines/example_dataframe.png)
