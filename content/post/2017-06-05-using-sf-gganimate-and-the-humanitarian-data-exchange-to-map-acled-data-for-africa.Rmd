...
categories: []
tags: [R, maps, datascience, acled, hdx, sf, gganimate]
Categories:
  - Development
  - GoLang
Description: ''
...
The code to run this example is on my github in an R markdown [file](https://github.com/callumgwtaylor/blog/blob/master/content/post/2017-06-05-using-sf-gganimate-and-the-humanitarian-data-exchange-to-map-acled-data-for-africa.Rmd).
...
```{r acled_2017, echo=FALSE, message=FALSE, warning=FALSE}
...
![animate_acled](../../docs/post/2017-06-05-using-sf-gganimate-and-the-humanitarian-data-exchange-to-map-acled-data-for-africa_files/figure-html/acled_month.gif)


```{r acled_monthly, echo=FALSE, message=FALSE, warning=FALSE}
...
gganimate(acled_month, "../../docs/post/2017-06-05-using-sf-gganimate-and-the-humanitarian-data-exchange-to-map-acled-data-for-africa_files/figure-html/acled_month.gif", ani.width=1000, ani.height=1000)
```