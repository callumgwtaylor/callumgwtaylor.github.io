...
I've also put them together as a mini-package that you can install from github: [hdxr](https://github.com/callumgwtaylor/hdxr). The code below is the OLD version, the up to date versions are on github.
